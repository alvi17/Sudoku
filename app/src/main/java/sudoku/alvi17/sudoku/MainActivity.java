...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //MainActivity.this.getWindow().setBackgroundDrawable(gradient);


        Drawable back = getResources().getDrawable(R.drawable.dada);

        MainActivity.this.getWindow().setBackgroundDrawable(back);
        ...
        switch (v.getId()) {
            ...
            case R.id.continue_button:
                if (getSharedPreferences("PREF", MODE_PRIVATE)
                        .getInt("flag", 3) != 3){
                    Intent intentContinue = new Intent(MainActivity.this, Game.class);
    ...
    private void openNewGameDialog() {
        // TODO Auto-generated method stub
		/*new AlertDialog.Builder(MainActivity.this).setTitle("��ʼ����Ϸ��������").setItems(
